...
/* 
	...
	period of time
*/
uint32_t ignition_interval = 5000u; //ms
...
void planner(){
  ...
  if((millis() - start_time) > 1000 && !brakeController.getMovingStatus()){ // after 1 sevond and brake has stopped
